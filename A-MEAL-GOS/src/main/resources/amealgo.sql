...
create table amg_restaurants( 
	amg_restaurant_id				serial, 
	place_id 						text, -- the Google Maps id for a specific place 
	restaurant_name					varchar(255), -- the name of the restaurant 
...
create table amg_meals( 
	...
	final_restaurant_id				int, -- the id of the most recent round of voting's restaurant finalist. 
...
create table amg_likes( 
	amg_like_id						serial, 
	restaurant_place_id				text, -- the Google Maps id for a specific place 
	amg_user_id 					int, 
...
create table amg_votes( 
	...
	amg_vote						smallint, -- negative = no, 0 = skip, positive = yes 
